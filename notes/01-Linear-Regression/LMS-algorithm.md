...
<img src="../../images/01/yi.jpg" width = "35%"/>
...
其中，<img src="../../images/01/p.jpg" width = "8%"/>表示定义参数<img src="../../images/common/delta.jpg" width = "3%"/>下，在给定*x*时*y*出现的概率分布，记为：<img src="../../images/01/yx.png" width = "10%"/>。
